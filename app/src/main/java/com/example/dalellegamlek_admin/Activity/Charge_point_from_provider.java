...
public class Charge_point_from_provider extends AppCompatActivity {
    Toolbar toolbar;
    ProgressBar progressBar;
    private RecyclerView recyclerView;
    private RecyclerView.LayoutManager layoutManager;
    private RecyclerAdapter_charge_event recyclerAdapter_secondry;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_charge_point_from_provider);
    ...
    public void fetchInfo() {
        ...
        Call<List<content_event>> call = apiinterface.getcontacts_charge();
        call.enqueue(new Callback<List<content_event>>() {
            ...
            public void onResponse(Call<List<content_event>> call, Response<List<content_event>> response) {
                ...
                recyclerAdapter_secondry = new RecyclerAdapter_charge_event(Charge_point_from_provider.this, contactList);
