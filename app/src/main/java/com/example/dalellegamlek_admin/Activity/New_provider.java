...
public class New_provider extends AppCompatActivity {
    Toolbar toolbar;
    ProgressBar progressBar;
    private RecyclerView recyclerView;
    private RecyclerView.LayoutManager layoutManager;
    private RecyclerAdapter_providersnotaccepted recyclerAdapter_secondry;
    ...
    public void fetchInfo() {
        ...
        Call<List<contact_users>> call = apiinterface.getcontacts_provider_not();
        call.enqueue(new Callback<List<contact_users>>() {
            ...
            public void onResponse(Call<List<contact_users>> call, Response<List<contact_users>> response) {
                ...
                recyclerAdapter_secondry = new RecyclerAdapter_providersnotaccepted(New_provider.this, contactList);
